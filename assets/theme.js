...
/* =========================================================
   HERO CLUB PRIVILÈGES — PARALLAX
========================================================= */

function initClubHeroParallax() {

  document
    .querySelectorAll('.club-hero')
    .forEach((hero) => {

      const heroImage =
        hero.querySelector('.club-hero__image');

      if (!heroImage) return;

      /*
        Empêche Shopify d'ajouter plusieurs fois
        les mêmes événements dans l'éditeur.
      */
      ...
      function updateParallax() {
        ...
        /*
          Distance parcourue dans le hero.
        */
